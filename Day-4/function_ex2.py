...
# print('Sum of 1,10,11 is: \t',min(1,10,11))
# print('Sum of 5,2 is: \t',min(5,2))
# print('Sum of 10,10,100,100,200,219,19 is: \t',min(10,10,100,100,200,219,19))

# print('Maximum Example')
# print('Sum of 1,10,11 is: \t',avg(1,10,11))
# print('Sum of 5,2 is: \t',avg(5,2))
# print('Sum of 10,10,100,100,200,219,19 is: \t',avg(10,10,100,100,200,219,19))